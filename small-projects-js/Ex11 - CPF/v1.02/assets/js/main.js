...
class CPF {
    ...
    penultimoDigito() {
        let cpfAntesTraço = this.cpf.slice(0, 9), contador = 10, valorTotal = 0;
    ...
    ultimoDigito() {
        let cpfMenosUltimoDigito = this.cpf.slice(0, 9) + this.penultimoDigito(), contador = 11, valorTotal = 0;
